...
const QUESTION_TYPES: { type: QuestionType; icon: string; label: string; desc: string }[] = [
  { type: 'mcq',    icon: '⊙', label: 'Multiple Choice', desc: 'Choose one answer' },
  { type: 'tf',     icon: '✓', label: 'True / False',    desc: 'Binary choice' },
  { type: 'fib',    icon: '_', label: 'Fill in Blank',   desc: 'Complete the gaps' },
  { type: 'short',  icon: '✎', label: 'Short Answer',    desc: 'Brief typed response' },
  { type: 'match',  icon: '⇄', label: 'Matching',        desc: 'Connect the pairs' },
  { type: 'essay',  icon: '§', label: 'Essay',           desc: 'Long-form writing' },
      ...
      <div>
        ...
        <div className="page-head">
          ...
          <div className="row" style={{ gap: 8 }}>
            <Button variant="secondary" size="sm">Preview as student</Button>
            <Button variant="secondary" size="sm">Save draft</Button>
            <Button variant="brand" size="sm" icon={Check}>Publish</Button>
          </div>
        </div>
